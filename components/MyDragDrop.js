...
export default function MyDragDrop() {
...
const initialData = {
  tasks: [
    { id: 1, content: "The first material" },
    { id: 2, content: "The second material" },
    { id: 3, content: "The third material" },
    { id: 4, content: "The fourth material" },
    { id: 5, content: "The fifth material" },
  ],
};
